...
class Annotator:
    ...
    descriptor = {}
    parameters = {
        'ros_pkg_path' : 'generic_pipeline',  # If set, use use data_path as a relative path to self.ros_pkg_path
    ...
    capabilities = {robokudo.types.annotation.Classification : ['leonie','lukas']}